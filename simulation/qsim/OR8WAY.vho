...
ARCHITECTURE structure OF OR8WAY IS
...
-- Equation(s):
-- \Y~0_combout\ = (!\A[0]~input_o\ & (!\A[1]~input_o\ & (!\A[2]~input_o\ & !\A[3]~input_o\)))
...
-- Equation(s):
-- \Y~1_combout\ = ( \Y~0_combout\ & ( (((\A[7]~input_o\) # (\A[6]~input_o\)) # (\A[5]~input_o\)) # (\A[4]~input_o\) ) ) # ( !\Y~0_combout\ )
