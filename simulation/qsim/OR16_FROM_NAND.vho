...
ARCHITECTURE structure OF OR16_FROM_NAND IS
...
-- Equation(s):
-- \Y~0_combout\ = (\B[0]~input_o\) # (\A[0]~input_o\)
...
-- Equation(s):
-- \Y~1_combout\ = (\B[1]~input_o\) # (\A[1]~input_o\)
...
-- Equation(s):
-- \Y~2_combout\ = (\B[2]~input_o\) # (\A[2]~input_o\)
...
-- Equation(s):
-- \Y~3_combout\ = (\B[3]~input_o\) # (\A[3]~input_o\)
...
-- Equation(s):
-- \Y~4_combout\ = (\B[4]~input_o\) # (\A[4]~input_o\)
...
-- Equation(s):
-- \Y~5_combout\ = (\B[5]~input_o\) # (\A[5]~input_o\)
...
-- Equation(s):
-- \Y~6_combout\ = (\B[6]~input_o\) # (\A[6]~input_o\)
...
-- Equation(s):
-- \Y~7_combout\ = (\B[7]~input_o\) # (\A[7]~input_o\)
...
-- Equation(s):
-- \Y~8_combout\ = (\B[8]~input_o\) # (\A[8]~input_o\)
...
-- Equation(s):
-- \Y~9_combout\ = (\B[9]~input_o\) # (\A[9]~input_o\)
...
-- Equation(s):
-- \Y~10_combout\ = (\B[10]~input_o\) # (\A[10]~input_o\)
...
-- Equation(s):
-- \Y~11_combout\ = (\B[11]~input_o\) # (\A[11]~input_o\)
...
-- Equation(s):
-- \Y~12_combout\ = (\B[12]~input_o\) # (\A[12]~input_o\)
...
-- Equation(s):
-- \Y~13_combout\ = (\B[13]~input_o\) # (\A[13]~input_o\)
...
-- Equation(s):
-- \Y~14_combout\ = (\B[14]~input_o\) # (\A[14]~input_o\)
...
-- Equation(s):
-- \Y~15_combout\ = (\B[15]~input_o\) # (\A[15]~input_o\)
